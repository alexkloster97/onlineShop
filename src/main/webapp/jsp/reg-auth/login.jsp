...
<body style="background:url(../../images/bg-body-bottom.png) repeat-x left bottom;">
    <div class="header">
        <div>
    ...
    <div class="body" >
        ...
        <div class="article">
            ...
            <div >
                <form action="controller" method="post" id="loginForm" class="form">
                    <input type="hidden" name="command" value="login">

                    <p class="field_label"><fmt:message key="user.login"/></p>
                    <input type="text" name="login" required maxlength="15" class="field_input"><br/>
                    ...
                    <input type="password" name="password" required maxlength="20" class="field_input"><br/>
                    <c:if test="${errorSet.contains('password.error')}">
                        <fmt:message key="register.error.password"/><br/>
                    </c:if>

                    <c:if test="${errorSet.contains('auth.error')}">
                        <fmt:message key="login.error.auth"/><br/>
                    </c:if>
                    <button type="submit" class="btn" style="margin-top: 15; float: right">
                        <fmt:message key="login.title"/>
                    </button>
                </form>
            </div>
    ...
    <div class="footer">
        <p style="padding-top: 40px">&#169; 2016 Azimova Lolita. All Rights Reserved.</p>
    </div>
